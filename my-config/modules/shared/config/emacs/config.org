...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "CI User"
    user-mail-address "ciuser@example.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/ciuser/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/ciuser/bin" "/profile/bin" "/Users/ciuser/.npm-packages/bin" "/Users/ciuser/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
